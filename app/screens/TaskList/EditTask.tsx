      ...
      <KeyboardAwareScrollView
        ...
        <Box flex={1} margin={16}>
          ...
          <Box
            ...
            {...styles.updateBtn}
            onPress={() => {
              const timeString = `${hoursInput === '' ? '00' : hoursInput}:${
                minutesInput === '' ? '00' : minutesInput
...
const styles = {
  ...
  updateBtn: { bg: 'BRAND_PRIMARY_BG', borderRadius: 8, padding: 16, underlayColor: 'TRANSPARENT45' } as BoxProps,
}
